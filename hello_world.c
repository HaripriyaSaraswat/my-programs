...
<meta name="verify-admitad" content="fb09364f2b" />
    ...
    <link rel="stylesheet" href="/public/css/onlinegdb.css?v=12" />
    
    
    <script>  var main_ide =  true;  </script>
    
    
    <script type="text/javascript" src="/public/js/onlinegdb.js?v=4"></script>
    ...
    <script type="text/javascript" src="/public/js/editor.js?v=4" defer></script>
    <script type="text/javascript" src="/public/js/main.js?v=32" defer></script>
